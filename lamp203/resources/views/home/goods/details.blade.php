				...
				<div class="single-page-row" id="detail-21">
					<div class="col-md-6 single-top-left">	
						<div class="flexslider">
							...
							<div id="small"><img src="/homes/images/s3.jpg" width="100%" id="smallImg">
								<div id="move"></div>
							</div>

							<ul id="uls">
								<li><img src="/homes/images/s3.jpg" width="100%"></li>
								<li><img src="/homes/images/s3.jpg" width="100%"></li>
								<li><img src="/homes/images/s3.jpg" width="100%"></li>
								<li><img src="/homes/images/s3.jpg" width="100%"></li>
							</ul>
							...
							<div id="big">
								<img src="/homes/images/s3.jpg" id="bigImg">
							</div>
